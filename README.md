...
[comment]: <> (##### `Текущий курс валюты`)

[comment]: <> (    method: POST)

[comment]: <> (    link: http://127.0.0.1:8000/api/v1/course/)

[comment]: <> (    data-parametrs: name)

[comment]: <> (##### `История курса валюты`)

[comment]: <> (    method: POST)

[comment]: <> (    link: http://127.0.0.1:8000/api/v1/course/history/)

[comment]: <> (    data-parametrs: key)
